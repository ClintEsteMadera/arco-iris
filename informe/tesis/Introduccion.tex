\section{Introducción}
	...
	\subsection{Motivación para este trabajo}
		...
		conlleva en el desempeño del sistema. El objeto del presente trabajo, al cual denominaremos ``Arco Iris'', es		el extender el comportamiento original de Rainbow modificando ciertos componentes del \emph{framework} para que		admitan nuevos conceptos que se explicarán más adelante.
