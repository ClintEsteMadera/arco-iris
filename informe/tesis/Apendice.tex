...
\label{sec:instalacionYEjecucionArcoIris}
	...
	\subsection{Compilación de Arco Iris y Arco Iris UI}
		...
		\begin{itemize}
			...
			\item construir JFaceGUI, \verb@arco-iris-core@ y \verb@arco-iris-ui@ de una sola vez, utilizando el
		...
		\subsubsection{Instalación Manual de Dependencias del Core de Arco Iris}
			...
			El mismo procedimiento debe ser reiterado para aquellas dependencias de de JFaceGUI que no se encuentran en
			...
			Cabe comentar que para los 3 proyectos Java aquí presentados (Arco Iris, Arco Iris UI y JFaceGUI) se incluye un
			directorio \verb@lib@ con las dependencias de cada proyecto, de modo que cada uno pueda compilar y correr sin que
			el usuario necesite disponer de una conexión a internet.
