\section{Extensión a Rainbow: Arco Iris}
	...
	\subsection{Introducción}
		...
		Como ya se ha comentado anteriormente, la idea de este trabajo es extender el \emph{framework} Rainbow para poder lograr
		un mecanismo de auto reparación más flexible y con mayor capacidad expresiva, con el objetivo de proveer mayor
		visibilidad a los \emph{stakeholders} de la aplicación sobre dicho proceso, permitiéndoles involucrarse en la definición
		de escenarios de atributos de calidad del sistema, de sus prioridades relativas y de las estrategias a considerar en la
