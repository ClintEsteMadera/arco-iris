\section{Extensión a Rainbow: Arco Iris}
	...
	\subsection{ATAM para Flexibilizar la Auto Reparación}
		...
		\subsubsection{El Estímulo en la Auto Reparación}
			...
			sistema, por ejemplo, para que una estrategia que soluciona problemas de \emph{performance} no sea tenida en cuenta
			al reparar un escenario relacionado a un atributo de calidad distinto, como por ejemplo el costo, debe agregarse una
