...
For scenarios to be well-formed it must be clear \ldots what the measurable or observable manifestation of the response
is.

Latency and throughput are two of the types of response measures noted in the attribute characterization.

Response: <a precise statement of the quality attribute response (e.g., response time, measure
of difficulty of modification)>

An important part of the response is a clear response measure. Simply saying ``modify the system
to incorporate the new discrete event generator'' would not describe how well the architecture
accommodated the modification. Given enough time and money, any modification is
possible. However, in this scenario, a response measure of ``two person-weeks'' is imposed,
forcing the architect to ensure that the system is modifiable with respect to some very particular
