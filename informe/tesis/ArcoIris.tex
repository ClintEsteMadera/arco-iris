\section{Extensión a Rainbow: Arco Iris}
	...
	\label{sec:strategySelection}
		...
		\label{sec:arcoIrisStrategyScoring}
			...
			puntaje de un escenario y cómo es utilizado para calcular el puntaje final de la estrategia, seleccionando Arco Iris 
			aquella de mayor puntaje para ser ejecutada:
