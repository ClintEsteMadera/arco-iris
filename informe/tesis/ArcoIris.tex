\section{Extensión a Rainbow: Arco Iris}
	...
	\subsection{Rainbow + Escenarios = ``Arco Iris''}
		...
		\subsubsection{Arquitectura de Arco Iris}
			...
			notificar la actualización sobre el modelo indicando el estímulo desencadenante. Las novedades sobre los cambios			ocurridos en el sistema en \emph{runtime} serán informados con el siguiente formato:			\verb@<Propiedad,Valor,Estímulo>@
			\todo{TURCO Y JONY: Seguir revisando desde acá!!!}
	...
	\subsection{ATAM para Flexibilizar la Auto Reparación}
		...
		\subsubsection{El Estímulo en la Auto Reparación}
			...
			\todo{TURCO: Aclarar bien como es el tema de los probes en Arco Iris: que deben ``interceptar'' los estímulos y
			presentamos dos \emph{posibles} formas: interceptores (si se puede tocar el sistema) u otro mecanismo como analizar
			logs, etc\ldots}
