...
\todo{agregar comparación de info reportada por los Probes con estimulos y sin estimulos}
		...
		\subsubsection{El Artefacto en la Auto Reparación}
			...
			Rainbow trabaja con el modelo de la arquitectura descripto en  Acme, contaremos con la especificación de los
			de las propiedades de los componentes y los conectores del sistema, entonces en el escenario de Arco Iris podremos
			contar con una vinculación directa con los componentes afectados. Al seleccionar un artefacto,
			el usuario de Arco Iris no estará más que eligiendo un componente o conector de la arquitectura del sistema, esto lo
			aprovecharemos para acotar las propiedades sobre las cuales podrá predicar la \textbf{Cuantificación de la
			Respuesta}.

			Para ejemplificar el concepto de artefacto utilizaremos la arquitectura presentada en Znn, recordemos que es una
			arquitectura cliente-servidor, de la cual en este caso tomaremos la especificación del componente \emph{ClientT}, a
			saber:
