	...
	\subsection{Activación del Mecanismo de Auto Reparación}
		...
		\label{sec:desarrolloMecanismoAutoReparacion}
			...
			\begin{enumerate}
				...
				\item Una vez identificados los escenarios potencialmente afectados, se verifica que se satisfagan, de acuerdo al
				algoritmo explicado en la sección \todo{PONER SECCION DONDE EXPLICAMOS ESTO!}.
