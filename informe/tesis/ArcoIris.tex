\section{Extensión a Rainbow: Arco Iris}
	...
	\label{sec:strategySelection}
		...
		\subsubsection{Puntuación de Estrategias según Rainbow}
			...
			Una vez obtenido el subconjunto de estrategias aplicables, Rainbow procederá a asignarle un puntaje (o \emph{score},
			en inglés) a cada una, el cual será un valor entre 0 y 100, y luego aplicará la estrategia de mayor puntaje.

			Para calcular el puntaje, lo primero que hará Rainbow será obtener los pesos asignados a cada \emph{concern}(e.g. costo,
			fidelidad, etc) según el escenario seleccionado (recordemos que el escenario ha sido configurado previo al inicio de
		...
		\label{sec:arcoIrisStrategyScoring}
			...
			no efectuará ninguna acción de auto reparación. Luego, por cada estrategia, Arco Iris simulará su aplicación
