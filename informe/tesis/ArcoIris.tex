		...
		\subsubsection{El Estímulo en la Auto Reparación}
			...
			\begin{Verbatim}[gobble=4]
				ClientProxyProbeWithStimulus0:
					...
					type: java 
					javaInfo:
						class: ar.uba.dc.thesis.znn.probes.ClientProxyProbeWithStimulus
						period: 2000
						args.length: 2
						args.0: "http://delegate.oracle/"
			...
			\todo{TURCO: (NO ACLARES QUE OSCURECE) Aclarar bien como es el tema de los probes en Arco Iris: que deben
			``interceptar'' los estímulos y presentamos dos \emph{posibles} formas: interceptores (si se puede tocar el sistema) u otro mecanismo como analizar
			logs, etc\ldots}
