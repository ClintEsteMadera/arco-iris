\section{Extensión a Rainbow: Arco Iris}
	...
	\subsection{Modelo de Arco Iris}
		...
		\todo{Quitar Heuristic del modelo}
		\todo{Donde hablamos del Artifact, actualizar: solo tiene name y systemName, quitar holds y
		getFullyQualifiedPropertyName}
		\todo{Corregir: un AtamScenario tiene muchos Environments}
		\todo{Agregar a SelfHealingScenario: applyFor, isBroken, isBrokenAfterStrategy}
		\todo{Quitar metodos de las subclases de RepairStrategies}
		\todo{Quitar SelfHealingConfiguration? Se menciona en algun lado? Se menciona SelfHealingConfigurationManager en
