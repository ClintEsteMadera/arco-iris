    ...
    Component Type ClientT extends ArchElementT with {
      ...
      Property reqRate : float <<  default : float = 0.0; >> ;
		...
		\subsubsection{El Entorno en la Auto Reparación}
			...
			escenarios cuyo entorno posea condiciones que no se satisfagan en el estado del sistema a la hora de recibir el			estímulo.			\todo{¿Cómo se determina el estado? Hablar de las properties, las constraints, etc.}
