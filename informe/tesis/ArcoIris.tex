\section{Extensión a Rainbow: Arco Iris}
	...
	\label{sec:strategySelection}
		...
		\todo{Agregar diagramas de secuencia en toda la sección como para clarificar un poco las explicaciones más
		complicadas?}
		...
		configuración más rigurosa del \emph{framework}, al mismo tiempo va en desmedro de la \emph{performance} de la auto
		...
		\label{sec:systemUtility}
			...
			Esto significa que una vez ejecutada esta táctica, de manera aproximada, la \emph{performance} se verá degradada en
