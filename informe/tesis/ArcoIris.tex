\section{Extensión a Rainbow: Arco Iris}
	...
	\subsection{ATAM para Flexibilizar la Auto Reparación}
		...
		\begin{quote}
			...
			proceso informa al operador y continúa su operación son caídas.
		\end{quote}
...
\todo{agregar comparación de info reportada por los Probes con estimulos y sin estimulos}
		...
		\subsubsection{El Artefacto en la Auto Reparación}
			...
			directa en su especificación con los componentes afectados. Al seleccionar un artefacto, el usuario de Arco Iris
			estará acotando las propiedades sobre las cuales podrá predicar la \textbf{Cuantificación de la	Respuesta}.

			Supongamos que estamos agregando auto reparación mediante Arco Iris a un sistema cliente-servidor, y queremos definir
			un escenario que indique que el mismo debe poseer Alta Disponibilidad, el artefacto sobre el cual predicaremos en
			este caso será el servidor. Una vez que el usuario haya seleccionado como artefacto del escenario al servidor, solo
			podrá predicar las propiedades del mismo, acotando las relacionadas a la disponibilidad.
