	...
	\subsection{Activación del Mecanismo de Auto Reparación}
		...
		\label{sec:desarrolloMecanismoAutoReparacion}
			...
			\begin{enumerate}
				...
				un mensaje que incluye una tripla \verb@<Propiedad,Valor,Estímulo>@, la cual a su vez será depositada en otra cola
				compartida entre todos los \emph{gauges}.
				\item El componente \emph{gauge coordinator} chequea periódicamente esta última cola en búsqueda de nuevas
				instrucciones para actualizar el modelo arquitectural con los cambios ocurridos en \emph{runtime}. Al encontrar el
