\section{Extensión a Rainbow: Arco Iris}
	...
	\subsection{ATAM para Flexibilizar la Auto Reparación}
		...
		\todo{Turco: Quitar contenido de Environment en la figura}\\
		\todo{Jony: por?}
		...
		\subsubsection{El Entorno en la Auto Reparación}
			\todo{en la seccion 4 explicamos el entorno especial ``ANY''. Probablemente eso sea mejor explicarlo acá\ldots}
	...
	\subsection{Configuración de Arco Iris}
		...
		\subsubsection{Actualización dinámica de cambios de configuración}
			...
			proponemos un simple mecanismo de detección de cambios en el archivo de configuración de Arco Iris el cual, al
			detectar cualquier cambio en dicho archivo, \textbf{reemplazará dinámicamente la configuración de Arco Iris cargada
			en memoria por la nueva configuración}; todo esto sin necesidad de reiniciar el \emph{framework}.
			...
			\todo{A esta altura deberiamos haber ya mencionado SelfHealingConfigurationManager} el cual, en ese caso, descarta
