\section{Extensión a Rainbow: Arco Iris}
	...
	\label{sec:strategySelection}
		...
		\label{sec:arcoIrisStrategyScoring}
				...
				Por cada estrategia
					...
					Por cada escenario habilitado
						Si (no aplica al entorno actual o
							...
							uf = funcion de utilidad para escenario.concern
							utilidad = uf(estimacionPorConcern(escenario.concern))
			...
			\emph{concern} del escenario, pero además de ponderar dicha utilidad con el peso del \emph{concern}
			(que en Rainbow es estático mientras que en Arco Iris dependerá del entorno actual del sistema), Arco Iris considerará
			también la prioridad relativa del escenario. Finalmente, el valor obtenido será acumulado al puntaje de la estrategia,
			escogiendo para reparar el sistema a aquella estrategia que posea el puntaje máximo.
