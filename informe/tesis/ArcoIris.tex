\section{Extensión a Rainbow: Arco Iris}
	...
	\subsection{Idea Básica}
		...
		IDEA:\\
		Empezar poniendo como funciona Rainbow (grafico), como funcionaria con nuestra extension (grafico) y encontrar la
		excusa para poner el diagrama de clases de Arco Iris
