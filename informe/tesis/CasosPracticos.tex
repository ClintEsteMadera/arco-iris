...
\label{sec:casosPracticos}
	...
	\subsection{Caso 6: Comportamiento Ante Los Cambios en el Entorno de Ejecución}
		...
		\todo{Turco: Implementar un caso de dos escenarios de distinto concern y distinto entorno (normal vs. alta carga) y
		ver como al ppio solo intenta arreglar el de normal y luego pasa a darle bola al de high load}
