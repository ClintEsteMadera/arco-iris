...
\label{sec:casosPracticos}
	...
	\subsection{Arquitectura del Sistema}
		...
		Puede verse el código fuente de la arquitectura en el apéndice \ref{sec:arquitecturaZNN}.
	...
	arquitectura del sistema. Puede verse las tácticas implementadas para Znn en el apéndice \ref{sec:tacticasZNN}.
	...
	concentrarnos en las prioridades entre escenarios al momento de escoger la estrategia candidata a reparar el sistema,
	...
	\subsection{Comportamiento del Sistema con un único Escenario}
		...
		escenario. El mismo consistirá en determinar un umbral (\emph{threshold}) de 600 ms. para el tiempo de respuesta
		...
		reparar. En la figura \ref{fig:scenario_expRespTime} se muestra el detalle del escenario creado.
	...
	\subsection{\emph{Tradeoff} entre Estrategias}
		...
		\emph{performance} con uno solo. Entonces, ¿por qué no minimizar el costo de los servidores? Pues lograremos esto
		...
		\begin{figure}[H]
			...
			\caption{Uso de prioridades favoreciendo al escenario de \emph{performance} sobre el de costo}
