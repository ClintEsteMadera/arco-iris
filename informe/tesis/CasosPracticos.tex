...
\label{sec:casosPracticos}
		...
		\begin{figure}[H]
			\begin{center}
				\subfigure[Uso de prioridades favoreciendo al escenario de eficiencia por sobre el de costo]
						  {\label{fig:testcase4_expRespTime}\includegraphics[width=1.00\textwidth]{images/testcase4_expRespTime.png}}
				\subfigure[Reducción del costo como consecuencia de un cambio en el entorno]
						  {\label{fig:testcase4_cost}\includegraphics[width=1.00\textwidth]{images/testcase4_cost.png}}
			\end{center}
	...
	\subsection{Caso 6: Comportamiento Ante Los Cambios en el Entorno de Ejecución}
		...
		% \todo{no deberíamos tener que poner tener que poner este clearpage acá\ldots} 
		\clearpage