\section{Casos Prácticos}
	\todo{TURCO: Mencionar que todos los concerns tienen el mismo peso, por ende no influyen en la seleccion de la estrategia a aplicar}
	...
	\todo{TURCO: agregar grafico de la GUI de escenarios}
	...
	\todo{TURCO: agregar grafico de expRespTime sin estrategia pero con escenarios (i.e: igual al grafico anterior pero marcando el threshold). Mostrar log para mostrar que no encuentra estrategias???}
	...
	\todo{agregar imagen de ScenarioUI del escenario de server cost}
