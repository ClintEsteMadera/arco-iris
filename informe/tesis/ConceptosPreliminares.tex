\section{Conceptos Preliminares}
	...
	\subsection{Atributos de Calidad y Restricciones}
		...
		requerimientos como seguridad, eficiencia, usabilidad, escalabilidad, etc. Sin embargo, esta división resulta
	...
	\subsection{Lenguajes de Descripción de Arquitecturas}
		...
		razonar sobre propiedades críticas del sistema, como por ejemplo la eficiencia o la confiabilidad. Ésta es la
	...
	\subsection{Rainbow}
		...
		\label{sec:failureRate}
			...
			es sopesado con el tiempo que ha pasado desde la última ejecución de la estrategia, permitiendo así que la misma
			vuelva potencialmente a ser considerada en futuras ejecuciones.
