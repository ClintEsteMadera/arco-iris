\section{Conceptos Preliminares}
	...
	\subsubsection{Znn: Evaluando la Efectividad de Rainbow}
		...
		\emph{performance} aceptable, pero a partir de un momento dado, se agregan 10 clientes comprometiendo así la
		\emph{performance} del mismo. De esta manera permite simular como responderían las estrategias implementadas ante
		dicha situación.
