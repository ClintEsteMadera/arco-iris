\section{Conceptos Preliminares}
	...
	\subsection{Auto Reparación}
		...
		intenta adaptar. Así, hoy en día, la adaptación de sistemas de software es costosa de construir, dificil de
		modificar, poco reusable entre distintos sistemas y generalmente solo provee soluciones a fallos de manera puntual.
	...
	\subsection{Rainbow}
		...
		\subsubsection{Introducción a Rainbow}
			...
			\begin{itemize}
				...
				\item Resolución: la habilidad de determinar cuándo las propiedades observadas del sistema violen los supuestos
