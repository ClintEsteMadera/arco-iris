\section{Conceptos Preliminares}
	...
	\subsection{Auto Reparación}
		...
		\todo{Ceria: toda esta sección hay que mejorarla un poco. Cuando hablen de self healing, aclaren que se refiere a
		reparar fallas, mientras que hay otros conceptos como self configuring o self adapting que se refieren a otros cambios
		...
		cuanto a disponibilidad se trata. Hoy en día los mismo operan en ambientes dinámicos, con requerimientos del
		...
		son comúnmente dependientes de cada aplicación y generalmente dependen del código de la aplicación que se intenta
		adaptar. Así, hoy en día, la adaptación de sistemas de software es costosa de construir, dificil de modificar, poco
		reusable entre distintos sistemas y generalmente solo provee soluciones a fallos de manera puntual.
	...
	\subsubsection{Auto Reparación de Sistemas Basada en Modelos de Arquitectura}
		...
		Otro sub-proyecto del proyecto Able, Rainbow (sobre el cual profundizaremos más adelante) utiliza esta técnica de
		\textit{closed-loop} para monitorear y reparar sistemas.
