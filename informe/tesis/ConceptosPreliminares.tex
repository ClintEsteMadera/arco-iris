\section{Conceptos Preliminares}
	...
	\subsection{Rainbow}
		...
		\subsubsection{Introducción a Rainbow}
			...
			\todo{Explicar más en detalle como funciona Rainbow}
			...
			automatiza la adaptación de sistemas dinámicos vía el modelo de la arquitectura del sistema, representaciones
			...
			\begin{figure}[H]
				...
				\caption{Rainbow usa un modelo abstracto para monitorear las propiedades de un sistema en tiempo de ejecución,
				evalúa el modelo detectando violaciones en las restricciones y al encontrar una, ejecuta adaptaciones sobre el
