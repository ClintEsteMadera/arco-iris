\section{Conceptos Preliminares}
	...
	\subsection{Atributos de Calidad}
		...
		\todo{Corregir el siguiente parrafo}
		Un \emph{concern} abarca un subconjunto de propiedades del sistema, como por ejemplo \emph{performance},
		costo o confiabilidad. En una arquitectura cliente-servidor, el \emph{concern} performance abarcaría las propiedades
		ancho de banda y carga del sistema, mientras que el \emph{concern} costo se encargaría del costo de los servidores.
			
		\todo{Extender explicacion de QA y agregar definicion de Concern}
	...
	\subsection{Rainbow}
		...
		\subsubsection{Introducción a Rainbow}
			...
			\subsubsection{Arquitectura de Rainbow}
				...
				\begin{enumerate}
					...
					dispara la adaptación en el caso que ocurra una violación en alguna restricción impuesta sobre el modelo. En ese
		...
		\subsubsection{Tácticas y Estrategias}
			...
			Las \textbf{tácticas} se definen como decisiones de diseño tendientes a controlar la respuestas del sistema a
			...
			Por otro lado, una \textbf{estrategia} se define simplemente como una colección de tácticas. La estrategia es la
			herramienta propuesta por Rainbow para quitar al sistema de un estado indeseable. Por ejemplo, al verse la
			performance del sistema comprometida, una estrategia podría agregar servidores hasta llevar la performance a un nivel
			adecuado.
			...
			Las estrategias son desarrolladas para asegurar el cumplimiento de un determinado requerimento sobre un
			\emph{concern} específico. 

			\todo{Explicar que la estrategia es una suerte de controlador. Tomar de doc/rainbow/CompArch 6-09.pdf}

			Como ya hemos mencionado, las estrategias se componen de tácticas, las cuales son, en último término, las
			responsables de llevar a cabo las modificaciones sobre sistema. Por ejemplo, en una arquitectura cliente-servidor,
			una estrategia podría definir agregar servidores mientras existan disponibles o, hasta que el tiempo de respuesta
			haya descendido  por debajo de un umbral determinado. Esta lógica sería descrita en la estrategia, mientras que será
			la táctica \verb@levantar-servidor@ la responsable de ejecutar la acción propiamente dicha.
		...
		\subsubsection{Ejemplo de una Táctica en Rainbow}
			...
			\todo{Tomar info y ejemplo Táctica de doc/rainbow/CompArch 6-09.pdf}
