\section{Conclusiones}
	...
	\subsection{Objetivo}
		...
		mismos. No es menor el hecho de que estas definiciones estén al alcance de todos \emph{stakeholders} participantes,
		...
		los sistemas autónomos introduciendo un modelo flexible de auto reparación basado en la arquitectura de los sistemas,
		ya que además de poner sobre el tablero los requerimientos, los hace visibles a todo el conjunto de participantes del		desarrollo. De esto se desprende directamente el hecho de que los sistemas podrán poseer un espectro más amplio de		soluciones, las cuáles serán seleccionadas según los requerimientos vayan modificándose como consecuencia de		variaciones en el entorno de ejecución bajo el cual el sistema deba responder. Este dinamismo en la reparación, así		como también la flexibilidad en el modelo de selección de soluciones y su fácil configuración, hacen de Arco Iris una		opción plausible a ser considerada y extendida para lograr avanzar en la flexibilización de sistemas inteligentes, a		la vez que permite incorporar cada vez más la utilización de la auto reparación en la industria del software.
