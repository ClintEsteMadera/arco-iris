\section{Conclusiones}
	...
	\ceria{Yo creo que en toda esta sección no están poniendo la idea más interesante de esta tesis, que es que los
	sistemas, en vez de implementar "soluciones" a los requerimientos, directamente van a "conocer su requerimientos", para
	que en vez de tener "una solución" tengan N soluciones que dependen de si esos requerimientos van cambiando o no, y eso
	se hace de manera dinámica. Muestren convicción de que creemos qeu ese es un camino interesante a seguir.}
