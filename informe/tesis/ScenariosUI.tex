\section{Interfaz Gráfica: Scenarios UI}
	...
	\subsection{Introducción}
		...
		\subsubsection{Herramienta de escritorio}
			...
			Entonces bien, ¿por qué hemos elegido construír Scenarios UI basado en una interfaz gráfica de usuario de escritorio?
	...
	\subsection{Puntos de extensión}
		...
		Scenarios UI (para ver puntos de extensión para Arco Iris, remitirse a la sección \ref{sec:puntos_extension}):
		\begin{itemize}
			\item Los \emph{artifacts} podrían seleccionarse del archivo .acme que contiene la descripción de la arquitectura del
