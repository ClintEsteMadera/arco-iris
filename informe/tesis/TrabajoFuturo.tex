...
\label{sec:trabajoFuturo}
	...
	\todo{
	- La idea original de Santiago de usar para algo los \emph{artifacts} vinculados al escenario\\
	...
	fuera)
	- Permitir agregar \emph{concerns} nuevos
	- leer los \emph{artifacts} y sus properties desde el .ACME
	- agregar mas tipos de \emph{constraints}
	}
