\section{Trabajo Futuro}
	...
	- Mi idea original de usar para algo los \emph{artifacts} vinculados al escenario\\
	...
	\todo{¿agregar arcoIrisSolutionWeight y rainbowSolutionWeight?}

	Desde ya se entiende que el presente trabajo deja abiertas muchas posibilidades de mejoras que serán necesarias al
	momento de implementar este \emph{framework} como una herramienta de uso generalizado en la industria, a continuación
	...
	\subsection{Análisis y Aprendizaje de la Auto Reparación}
		...
		eliminada de las estrategias candidatas.
		...
		desactivar la estrategia. También debería permitirse modificar dinámicamente tanto la lógica de la estrategia
		\todo{lo siguiente ya está hecho!} como las condiciones esperadas en el escenario.
	...
	\subsection{Configuración de Escenarios en AcmeStudio}
		...
		\footnote{Para más información acerca de AcmeStudio, visitar \url{http://www.cs.cmu.edu/~acme/AcmeStudio}} la cual se
	...
	\label{sec:puntos_extension}
		...
		\begin{itemize}
			\item Mi idea original de usar para algo los \emph{artifacts} vinculados al escenario
			...
			\item{Permitir agregar \emph{concerns} nuevos}
			\item{leer los \emph{artifacts} y sus properties desde el .ACME}
			\item{agregar mas tipos de \emph{constraints}}
		\end{itemize}
