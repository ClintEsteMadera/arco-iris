...
\label{sec:trabajoFuturo}
	...
	\subsection{Optimización en la Selección de la Estrategia}
		...
		\ceria{
		El 6.8 es muy importante. Recuerden que Garlan habló de esto como una tesis de doctorado. Me parece que dentro de
		trabajo futuro hablan de muchas ``cosas chicas''. Mencionen también las grandes líneas que se deben seguir explorando para
		hacer realidad esto de los sistemas ``autoreparables''. Cómo armar una arquitectura de un sistema existente en ACME (lo de
		Discotect, pero que todavía es limitado), cómo ``enchufarse'' con un sistema sobre el que se tiene poco control, cómo
		poder alterar más radicalmente el comportamiento de un sistema, etc. Pueden poner estos temas en general, pero me
		gustaría que muestren que es muy importante seguir avanzando en sistemas que se ``manejan solos''.}
