...
\label{sec:trabajoFuturo}
	...
	\todo{La idea original de Santiago de usar para algo los \emph{artifacts} vinculados al escenario}
	...
	\subsection{Análisis y Aprendizaje de la Auto Reparación}
		...
		\subsubsection{Mecanismo Inteligente de Detención de Estrategias Fallidas}

			\todo{Acá habría que explicar que hay hoy en Rainbow y pq es insuficiente o poco flexible. La idea de las alarmas no
			me gusta: esto es para que los admines tengan que laburar menos\ldots}
	...
	\subsection{Flexibilización del Entorno}
		...
		e.g. alta carga y super alta carga (a.k.a. hasta las tetas) ).}
