...
\label{sec:trabajoFuturo}
	...
	\subsection{Atributos de Calidad y \emph{Concerns} configurables por el usuario}
		...
		\todo{Completar de acuerdo a lo escrito en el e-mail del 19/4 y de acuerdo a lo decidido}

		Actualmente Arco Iris maneja un conjuntos fijo de Atributos de Calidad y \emph{Concerns}, el cual se encuentra
		embebido en clases Java a las cuales el usuario final no puede acceder. En otras palabras, el usuario no puede agregar
		libremente nuevos \emph{Concerns}. Claramente, esta rigidez restringe la usabilidad del \emph{framework} y debe ser superada.
		
		La manera más sencilla de compensar la falencia antes mencionada, es agregando una variada y amplia gama de Atributos
		de Calidad y \emph{Concerns} en el código fuente de Arco Iris.

		La solución definitiva actualmente es un poco más complicada.
