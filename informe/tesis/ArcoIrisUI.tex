\section{Interfaz Gráfica: Arco Iris UI}
	...
	\subsection{Introducción}
		...
		\subsubsection{Herramienta de escritorio}
			...
			Entonces bien, ¿por qué hemos elegido construir Arco Iris UI basado en una interfaz gráfica de usuario de escritorio?
	...
	\subsection{Conceptos básicos de uso de la herramienta}
		...
		\subsubsection{Una configuración de \emph{Self Healing} subyacente}
			...
			la computadora que se encuentra corriendo Arco Iris UI. Recordemos que, de estar el usuario editando el archivo
			de configuración que Arco Iris está utilizando en \emph{runtime}, cualquier cambio automáticamente guardado por
			Arco Iris UI será automáticamente detectado por Arco Iris, lo cual dinamiza el comportamiento original
	...
	\subsection{Administración de Escenarios}
		...
		\label{sec:strategySelectionUI}
			...
			\begin{figure}[ht]
				\centering
					\includegraphics[width=1.00\textwidth]{images/arcoIrisUI_select_repair_strategy_all_1.png}
				\caption{Elección de todas las estrategias de reparación disponibles}
			\end{figure}

			\begin{figure}[ht]
				\centering
					\includegraphics[width=1.00\textwidth]{images/arcoIrisUI_select_repair_strategy_all_2.png}
