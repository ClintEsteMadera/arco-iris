...
\section{Conceptos Preliminares}
	...
	\subsection{Rainbow}
		...
		\begin{frame}[containsverbatim]
			...
			\nota{los invariantes seran utilizados por Rainbow para saber cuándo reparar el sistema}
		...
		\subsubsection{Escenarios de Atributos de Calidad}
			...
			\begin{frame}
				...
				\begin{itemize}[<+->]
					...
					\alert{Invariantes sólo en los escenarios.}
					\item \sout{Poco dinámico, debido a:}
					\begin{itemize}
						\item \sout{no se adapta al entorno de ejecución}\\\alert{Entornos dinámicos}.
						\item \sout{configuración compleja}\\\alert{Configuración de escenarios mediante Arco Iris UI}. 
...
\section{Trabajo a Futuro y Conclusiones}
	...
	\subsection{Conclusiones}
		...
		\begin{frame}
			...
			\nota{framework generico y personalizable: soluciones que se \textbf{adaptan dinámicamente} ante \textbf{cambios en
			el entorno} de ejecución}
			
			\nota{Finalizar con: Arco Iris es una opción interesante a ser considerada para su estudio y extensión, a fin de
			\textbf{continuar avanzando en la flexibilización de herramientas de auto reparación}}
