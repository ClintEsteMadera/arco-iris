...
public class SelfHealingScenario extends AtamScenario {
	...
	/**
	 * Este m�todo es el que normalmente se usa para determinar si un escenario est� roto.
	 * <p>
	 * Este m�todo est� pensado para ser usado �nicamente por una instancia de {@link ScenarioBrokenDetector}. Por eso
	 * es protected.
	 */
