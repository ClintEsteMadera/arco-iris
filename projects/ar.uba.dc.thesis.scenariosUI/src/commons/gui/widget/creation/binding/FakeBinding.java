...
public class FakeBinding implements Binding {
	 ...
	 * retornará el método <code>getValue()</code>
	 * 
	 * @param label
	...
	public Object getModel() {
		throw new UnsupportedOperationException("No se debería invocar al método getModel() de un FakeBinding!");
	}

	public String getPropertyName() {
		throw new UnsupportedOperationException("No se debería invocar al método getPropertyName() de un FakeBinding!");
	}
