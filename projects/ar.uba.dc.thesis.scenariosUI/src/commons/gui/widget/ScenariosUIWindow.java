...
public class ScenariosUIWindow extends MainWindow {
	...
	/**
	 * Actualiza la tabla con los ítems de una consulta determinada, teniendo en consideración que
	 * si un ítem es modificado, sólo se pide a la capa de persistencia dichos ítems y no todos;
	 * favoreciendo la performance del sistema.
	 *
	 * @param nombreConsulta
	 *            el nombre de la consulta. NO puede ser nulo.
	 * @param id
	 *            el identificador único del objeto que se intenta refrescar. (si el parámetro es
	 *            nulo, la consulta se actualizará completa.
	 */
	...
	/**
	 * Método de conveniencia para realizar invocaciones más limpias (desde la perspectiva del
	 * usuario). Es equivalente a invocar al método resetConsulta(TableConstants, Long) con el
	 * segundo parámetro en <code>null</code>.
	 *
	 * @param nombreConsulta
	 *            el nombre de la consulta. NO puede ser nulo.
	 */
