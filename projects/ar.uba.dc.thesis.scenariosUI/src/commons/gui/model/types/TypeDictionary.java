...
public class TypeDictionary {
	 ...
	 * el tipo por default para la clase (es decir el tipo con identificador
	 * nulo)
	 * 
	 * <br>
	 * Más precisamente, el proceso de búsqueda es el siguiente:
	 * <br>
	 * 
	 * <ul>
	 * 
	 * <li>
	 * 1 - Si se encuenta una entrada para el tipo especificado, se retorna el valor
	 * encontrado.
	 * </li>
	 *
	 * <li>
	 ...
	 * <code>new EditType(superClass,id)</code>, donde <code>superClass</code>
	 * es la clase base del <code>EditType<code> original y <code>id</code> es el identificador
	 * del <code>EditType<code> original.
	 * </li>
	 *
	 * 3 - Si no se encuentra con el precedimeinto anterior, se invoca la búsqueda 
	 * utilizando el identificador <code>new EditType(clazz,null)</code>, donde <code>clazz</code>
	 * es la clase del <code>EditType<code> original. De esta forma se obtiene la 
