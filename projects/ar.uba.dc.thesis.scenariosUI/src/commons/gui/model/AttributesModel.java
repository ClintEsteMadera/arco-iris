...
public class AttributesModel<T> extends ValueHolder<T> implements CompositeModel<T>, Attributes {
	...
	/**
	 * @see commons.gui.model.Attributes#getAttribute(Object)
	 */
	@SuppressWarnings("unchecked")
	...
	/**
	 * @see commons.gui.model.ComplexModel#getValue(Object)
	 */
	...
	/**
	 * @see commons.gui.model.ComplexModel#getValueType(Object)
	 */
	...
	/**
	 * @see commons.gui.model.ComplexModel#setValue(Object, Object)
	 */
	@SuppressWarnings("unchecked")
	...
	/**
	 * @see commons.gui.model.ComplexModel#addComplexValueChangeListener(ComplexValueChangeListener)
	 */
	...
	/**
	 * @see commons.gui.model.ComplexModel#removeComplexValueChangeListener(ComplexValueChangeListener)
	 */
