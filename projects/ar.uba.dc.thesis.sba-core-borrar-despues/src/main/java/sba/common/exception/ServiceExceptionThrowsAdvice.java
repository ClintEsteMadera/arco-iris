...
/**
 * Clase encargada de interceptar todas las excepciones y asegurarse que se retorne un mensaje
 * adecuado para ser mostrado al usuario. En caso de ser una excepción de la jerarquía de
 * <code>ServiceException</code> el mensaje original será el definitivo, por lo que debe ser
 * adecuado para mostrar al usuario; en otro caso se mostrará un error genérico. <br>
 * NOTA: se podría realimentar esta clase para interpretar las excepciones más recurrentes y generar
 * un mensaje más específico.
 * 
	...
	public void afterThrowing(Exception ex) throws Throwable {
		...
		if (!excepcionListaParaMostrarAlUsuario) {
			...
			if (ex instanceof StaleObjectStateException
				...
				// Se intenta actualizar una fila que ha sido modificada previamente
				throw new ApplicationException(ROW_WAS_UPDATE_OR_DELETE_BY_ANOTHER_TRANSACTION, ex);
			}
