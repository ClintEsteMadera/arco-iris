...
public class ValidationResult {
	...
	/*
	 * (non-Javadoc)
	 * @see sba.common.validation.IValidationResult#hasErrors()
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see sba.common.validation.IValidationResult#getErrorCount()
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see sba.common.validation.IValidationResult#getErrors()
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see sba.common.validation.IValidationResult#addErrors(sba.common.validation.ValidationResult)
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see sba.common.validation.IValidationResult#addError(java.lang.String,
	 *      sba.common.properties.EnumProperty)
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see sba.common.validation.IValidationResult#addError(sba.common.properties.EnumProperty)
	 */
	 ...
	 * (non-Javadoc)
	 * @see sba.common.validation.IValidationResult#addError(java.lang.String,
	 *      sba.common.properties.EnumProperty, java.lang.Object)
	 */
	public void addError(String errorLocation, EnumProperty validationMessage, Object... args) {
		this.validationErrors.add(new ValidationError(getPath(errorLocation), validationMessage,
				args));
	}
	...
	/*
	 * (non-Javadoc)
	 * @see sba.common.validation.IValidationResult#getErrorMessage()
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see sba.common.validation.IValidationResult#pushNestedPath(int)
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see sba.common.validation.IValidationResult#pushNestedPath(java.lang.String)
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see sba.common.validation.IValidationResult#popNestedPath()
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see sba.common.validation.IValidationResult#pushValueDescription(java.lang.String)
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see sba.common.validation.IValidationResult#popValueDescription()
	 */
	public void popValueDescription() {
		if (this.valueDescription.length() == 0) {
			throw new IllegalStateException(
					"No se hizo previamente un push del 'value description'");
		}
	...
	/*
	 * (non-Javadoc)
	 * @see sba.common.validation.IValidationResult#getValueDescription()
	 */
	...
	private String getPath(String location) {
		return nestedPath.length() == 0 ? location : 
				nestedPath + (location.length() > 0 ? PATH_SEPARATOR + location : "");
	}

	private static String getPath(String nestedPath, String location) {
		return nestedPath.length() == 0 ? location : location.length() == 0
				? nestedPath
				: nestedPath + PATH_SEPARATOR + location;
	}
