...
/**
 * Modelo compuesto que utiliza bean-reflection para acceder a las propiedades de un objeto. Permite adaptar un POJO
 * (Plain Old Java Object), convirtiendolo en un modelo compuesto. <br>
 * <br>
 * Es un {@link jface.gui.gui.model.ValueModel} que a su vez contiene modelos "hijos" asociados a las propiedades del
