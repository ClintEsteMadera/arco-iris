...
class PropertyName {
	 ...
	 * Ejemplos
	 * 
	 * "emisor.denominacion" está incluida en "emisor" "emisor" está incluida en "emisor"
	 * 
	 ...
	 * Ejemplos
	 * 
	 * "emisor.denominacion" está incluida en "emisor" "titulo.persona.denominacion" está incluida en "titulo" o en
	 * "titulo.persona"
	 * 
	 * @param parentProperty
	 * @return
	...
	/**
	 * Obtiene la propiedad tal como se identifica en el modelo "padre" que contiene a la propiedad
	 * 
	 * @param key
	 * @return
	 */
