...
public class ValidationManager {
	...
	private static final String VALIDATION_STATUS_KEY = ValidationManager.class
			.getName() + ".validationInfo";

	private static final String VALIDATION_PROPERTY_KEY = ValidationManager.class
			.getName() + ".validationProperty";
	...
	public static void setValidationProperty(Control c, CompositeModel m,
			String property) {
