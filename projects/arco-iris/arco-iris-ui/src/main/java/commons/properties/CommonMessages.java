...
public enum CommonMessages implements EnumProperty {
	...
	AUTH_LOGIN_MESSAGE, AUTH_LOGIN_ERROR_MSG, AUTH_LOGIN_TITLE, EXIT_DIALOG_MESSAGE, NO_SELECTED_ELEMENT,

	QUERY_NO_RESULTS, QUERY_ONLY_ONE_RESULT, QUERY_MORE_THAN_ONE_RESULT;
