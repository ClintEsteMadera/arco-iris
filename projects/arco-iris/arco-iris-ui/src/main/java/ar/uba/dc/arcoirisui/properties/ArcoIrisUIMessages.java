...
public enum ArcoIrisUIMessages implements EnumProperty {
	...
	private static ResourceBundle messages = ResourceBundle.getBundle("arcoIrisUI_messages");

	private static final Log log = LogFactory.getLog(ArcoIrisUIMessages.class);
}