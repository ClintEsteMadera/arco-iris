...
import ar.uba.dc.arcoirisui.gui.util.ConstraintType;
...
public class ConstraintComposite extends SimpleComposite {
	...
	private void createConstraintTypeSelection(Composite parent, boolean addEmptyOption) {
		...
		ComboMetainfo comboMetainfo = ComboMetainfo.create(composite, ArcoIrisUILabels.CONSTRAINT_TYPE,
	...
	private void createTabForNumericBinaryRelationalConstraint() {
		...
		LabelFactory.createLabel(tab, ArcoIrisUILabels.ARTIFACT, false, false);

		this.createSeparator(tab);

		LabelFactory.createLabel(tab, ArcoIrisUILabels.PROPERTY, false, false);
