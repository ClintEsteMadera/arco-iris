...
/**
 * This class provides the default guidelines for any Query Composite within the application "ArcoIris UI".
 * 
 * @param <T>
 *            the type of the items contained in the table within this Query Composite.
 */
public abstract class ArcoIrisUIQueryComposite<T> extends QueryComposite<T> {

	public ArcoIrisUIQueryComposite(Composite parent, EnumProperty tableName, Class<T> tableElementsClassName,
	...
	protected final OpenDialogWithPurposeAction<Environment, Purpose> getActionForView() {
		throw new RuntimeException(
				"This method should not be called since ArcoIris UI does not allow viewing on its QueryComposites");
	}
