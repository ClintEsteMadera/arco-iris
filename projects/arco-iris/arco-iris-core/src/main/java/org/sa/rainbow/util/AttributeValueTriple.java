...
public class AttributeValueTriple extends Pair<TypeNamePair, Object> {
	 ...
	 * 
	 * @param attr
	 *            a TypeNamePair describing the attribute
	 * @param v
	 *            the value object
	 */
	 ...
	 * 
	 * @param type
	 *            the String describing the type
	 * @param name
	 *            the String describing the name
	 * @param v
	 *            the value object
	 */
	...
	public String toString() {
		...
		Object value = value();
		return name() + (type == null ? "" : ":" + type) + (value == null ? "" : "=" + value.toString());
	}
	...
	/**
	 * Updates the type name of the value, as well as "reparses" the value using this new type info, and update the
	 * value Object.
	 * 
	 * @param newType
	 *            the new type name
	...
	/**
	 * Parses a string of the form "name"[:"type"][=value] into a Triple object, which is actually composed of a Pair of
	 * TypeNamePair and a Value Object. This method treats the value as String type by default, if not type is parsed
	 * from the "val" string. Equivalent to calling: <blockquote>
	 * <code>AttributeValueTriple.parseValueTriple(val, DEFAULT_TYPE);</code> </blockquote>
	 * 
	 * @param str
	...
	public static AttributeValueTriple parseValueTriple(String val, String defaultType) {
		AttributeValueTriple valueTriple = AttributeValueTripleWithStimulus.parseValueTriple(val, defaultType);
		if (valueTriple != null) {
			return valueTriple;
		}
