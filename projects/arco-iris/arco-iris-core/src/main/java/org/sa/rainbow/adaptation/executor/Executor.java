 ...
 * {@link ArcoIrisAdaptationManager} instead of {@link AdaptationManager}
 * <p>
	...
	protected void runAction() {
		if (!m_queue.isEmpty()) {
			...
			if (!Rainbow.shouldTerminate()) {
				((ArcoIrisAdaptationManager) Oracle.instance().adaptationManager()).markStrategyExecuted(strategy);
			}
		}
	}
