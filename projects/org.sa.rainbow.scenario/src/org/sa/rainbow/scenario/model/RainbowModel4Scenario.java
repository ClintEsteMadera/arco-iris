...
public class RainbowModel4Scenario extends RainbowModel {

	public RainbowModel4Scenario() {
		super();
	...
	private static final RainbowLogger logger = RainbowLoggerFactory.logger(RainbowModel4Scenario.class);
}
