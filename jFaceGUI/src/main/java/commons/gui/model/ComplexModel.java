 ...
 * <br>
 * Estos modelos contienen uno o mas <code>ValueModel</code>, que pueden ser accedidos mediante claves.
 */
public interface ComplexModel {
	 ...
	 *             en caso de la clave no corresponda a un valor modificable del modelo. ser accedida.
	 */
	...
	/**
	 * Obtiene un contenedor de valor "generico" para una propiedad. El objetivo de este metodo es que las
	 * implementaciones puedan proveer una via mas eficiente para la manipulacion de un valor en particular.
	 * 
	 * @param key
	 *            Identificador de la propiedad
